  ...
  methods: {
    ...
    loadQuestion: function() {
      if (this.state.isMulti) {
        ...
        // get # from 0-3, thats the position where the correct answer goes
        ...
        console.log("cant deal with true false questions yet!!! todo");
        this.nextQuestion()
      }
    },
    getRand: function() {
      //returns an int between 0 and 3
      return parseInt((Math.random()*4).toString().substring(0,1))
    },
    ...
    checkAnswer: function(event) {
      ...
      //conditional to prevent players trying multiple answers on the same question
          ...
          if (event.target.innerText === this.getCurrentQuestion().correct_answer) {
